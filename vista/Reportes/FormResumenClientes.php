...
<script>
Phx.vista.FormResumenClientes=Ext.extend(Phx.frmInterfaz,{
    ...
    {   
       ...
       Phx.vista.FormResumenClientes.superclass.constructor.call(this,config);
       this.init(); 
       this.iniciarEventos(); 
    ...
    loadValoresIniciales: function(){
    	Phx.vista.FormResumenClientes.superclass.loadValoresIniciales.call(this);
