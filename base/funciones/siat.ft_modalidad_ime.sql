	...
	***********************************/
	...
	if(p_transaccion='SIA_MODSIA_INS')then
        ...
        begin
			...
			)ON CONFLICT ON CONSTRAINT tmodalidad_codigo_key 
...
ALTER FUNCTION siat.ft_modalidad_ime (p_administrador integer, p_id_usuario integer, p_tabla varchar, p_transaccion varchar)
  OWNER TO postgres;