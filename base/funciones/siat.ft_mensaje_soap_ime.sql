	...
	***********************************/
	...
	if(p_transaccion='SIA_MESSIA_INS')then
        ...
        begin
			...
			null,
			null
			)ON CONFLICT ON CONSTRAINT tmensaje_soap_codigo_key 
...
ALTER FUNCTION siat.ft_mensaje_soap_ime (p_administrador integer, p_id_usuario integer, p_tabla varchar, p_transaccion varchar)
  OWNER TO postgres;