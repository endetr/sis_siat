CREATE OR REPLACE FUNCTION "siat"."ft_cuf_ime" (	
				p_administrador integer, p_id_usuario integer, p_tabla character varying, p_transaccion character varying)
RETURNS character varying AS
$BODY$

/**************************************************************************
 SISTEMA:		Sistema de Siat
 FUNCION: 		siat.ft_cuf_ime
 DESCRIPCION:   Funcion que gestiona las operaciones basicas (inserciones, modificaciones, eliminaciones de la tabla 'siat.tcuf'
 AUTOR: 		 (admin)
...
#ISSUE				FECHA				AUTOR				DESCRIPCION
 #0				21-01-2019 15:18:42								Funcion que gestiona las operaciones basicas (inserciones, modificaciones, eliminaciones de la tabla 'siat.tcuf'	
 #
 ***************************************************************************/
...
BEGIN
    ...
    v_nombre_funcion = 'siat.ft_cuf_ime';
    v_parametros = pxp.f_get_record(p_tabla);

	/*********************************    
 	#TRANSACCION:  'SIA_CUF_INS'
 	#DESCRIPCION:	Insercion de registros
 	#AUTOR:		admin	
 	#FECHA:		21-01-2019 15:18:42
	***********************************/

	if(p_transaccion='SIA_CUF_INS')then
					
        begin
        	--Sentencia de la insercion
        	insert into siat.tcuf(
			nro_factura,
	...
	/*********************************    
 	#TRANSACCION:  'SIA_CUF_MOD'
 	#DESCRIPCION:	Modificacion de registros
 	#AUTOR:		admin	
 	#FECHA:		21-01-2019 15:18:42
	***********************************/

	elsif(p_transaccion='SIA_CUF_MOD')then

		begin
			--Sentencia de la modificacion
			update siat.tcuf set
	...
	/*********************************    
 	#TRANSACCION:  'SIA_CUF_ELI'
 	#DESCRIPCION:	Eliminacion de registros
 	#AUTOR:		admin	
 	#FECHA:		21-01-2019 15:18:42
	***********************************/

	elsif(p_transaccion='SIA_CUF_ELI')then

		begin
			--Sentencia de la eliminacion
			delete from siat.tcuf
            where id_cuf=v_parametros.id_cuf;
...
COST 100;
ALTER FUNCTION "siat"."ft_cuf_ime"(integer, integer, character varying, character varying) OWNER TO postgres;
